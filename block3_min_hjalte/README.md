...
Här kommer några tips:
    ...
    Du kan byta bakgrund på scenen om du vill ändra miljön, till exempel att natt förvandlas till dag eller att regnväder förvandlas till solsken.
    Du kan animera hjälte-sprajtens klädslar eller ändra storlek eller färgeffekt på sprajten om du vill att hjälten ska ändra utseende i slutet av berättelsen.
    Du kan lägga till fler sprajtar som visas i slutet av berättelsen, så att de dyker upp när motståndaren är borta.
    Du kan lägga till fler sprajtar som är med i berättelsen hela tiden och som byter klädsel i slutet på berättelsen.
    Låt hjälten eller andra sprajtar säga fler saker om det behövs för att förklara hur berättelsen slutar!
...
Här kommer några tips:
    ...
    Nu kan du ändra din Hjälte så som du vill att den ska se ut! Gå in på sprajtens klädslar och använd ritverktygen för att göra om din hjälte. Använd till exempel penseln för att rita eller färgburken för att ändra färg på exempelvis kläder eller hår.
    Om du inte redan har animerat din hjälte-sprajt kan du nu kopiera klädseln så att hjälten har flera utseenden. Ändra något i den ena klädseln så kan du animera mellan de båda! Vissa sprajtar har redan flera klädslar att animera mellan, till exempel så att hjälten rör på benen eller ändrar ansiktsuttryck.
    Du kan ändra motståndar-sprajten om du vill att den ska se annorlunda ut eller ha klädslar att animera mellan. Kanske ska motståndaren ändra ansiktsuttryck när hjälten möter den?
    Om du vill att fler saker ska hända i berättelsen, så kan du nu lägga till fler sprajtar och koda dem. Testa dig fram och se vad som händer!
    Du kan ha fler bakgrunder till scenen och animera dem om du vill att berättelsen ska byta miljö.
    Du kan lägga till en bakgrund som inleder berättelsen och i ritverktyget skriva en text som förklarar berättelsen, till exempel börja med ”Det var en gång…”. 
    Du kan också lägga till en bakgrund som avslutar berättelsen och skriva en text som förklarar vad som händer sedan, till exempel ”Så levde de lyckliga i alla sina dagar. Snipp snapp slut så var sagan slut!”. 
