...
Testa ett exempelspel av **Rymdhunden - del 3**. Klicka på bilden nedan och starta exempelspelet genom att klicka på gröna flaggan. Hunden föjer efter muspekaren (eller ditt finger om du har pekskärm). <a href="https://scratch.mit.edu/projects/646070379" target="_blank"> ![Exempelprojekt i Scratch för spelet Rymdhunden - del 3](BILD_SCEN__hund_ny_sprajt_robot.png)</a>
